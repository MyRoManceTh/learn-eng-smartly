...
// ════════════════════════════════════════════
// 10. AURA ANIMATIONS — Using shared auraEffects module
// ════════════════════════════════════════════

import { renderAura, STICKER_SCALE, type AuraParticle } from "./auraEffects";
...
export function setupAuraAnimation(
  ...
  const update = (dt: Ticker) => {
    ...
    gfx.clear();
    renderAura(gfx, particles, time, STICKER_SCALE, auraId);
  };
